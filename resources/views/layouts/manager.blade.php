...
<head>
   ...
   <title>QuickTours (manager panel)</title>
</head>
      ...
      <body>
         <div id="app">
            ...
            <div class="admin-wrapper">
               <a class="admin-wrapper-btn" href="{{route('show.cities')}}">Список городов</a>
               <a class="admin-wrapper-btn" href="{{route('showForCreate.service')}}">Добавить услугу</a>
               <a class="admin-wrapper-btn" href="{{route('showForCreate.hotel')}}">Добавить отель</a>
               <a class="admin-wrapper-btn" href="{{route('showForCreate.tour')}}">Добавить тур</a>
               <a class="admin-wrapper-btn" href="{{route('showForCreate.ticket')}}">Добавить билет</a>
               <a class="admin-wrapper-btn" href="">Список заказов </a>
               <a class="admin-wrapper-btn" href="{{route('show.tickets')}}">Список билетов </a>
               <a class="admin-wrapper-btn" href="{{route('show.service')}}">Список услуг</a>
            </div>
